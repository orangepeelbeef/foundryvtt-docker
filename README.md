...
|`felddy/foundryvtt:11.309.0`| An exact image version. |
|`felddy/foundryvtt:11.309`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `11.309` |
...
```console
docker build \
  --build-arg VERSION=11.309.0 \
  --tag felddy/foundryvtt:11.309.0 \
