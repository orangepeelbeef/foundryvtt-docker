...
|`felddy/foundryvtt:11.308.0`| An exact image version. |
|`felddy/foundryvtt:11.308`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION`             | Version of Foundry Virtual Tabletop to install.                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `11.308`                |
...
docker build \
  ...
  --tag felddy/foundryvtt:11.308.0 \
